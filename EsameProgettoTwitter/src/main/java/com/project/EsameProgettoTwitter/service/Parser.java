...
public class Parser {
	...
	/**
	 * effettua il parsing salvando le proprietà più rilevanti in oggetti Proprieties
	 * @param json
	 * @return
	 */
	public static ArrayList<Proprieties> Parsing(JSONArray json) {
		...
		//iterazione per prendere tutti gli elementi di user_mentios e metterli in array di Strings diversi
